...
//alleys
	...
	echo "<center><div style='
			...
			box-shadow: 20px 20px 15px rgba(0,16,0,0.5);'><a href='../?page=apartment' title='ENTER'><img style='width:400px; height:400px;' src='../images/alleys.jpg' /></a><br /><center></center>
			</div><br /><br /><div style='transform: translate(0px, 25px); font-family: MingLiU-ExtB, Microsoft Yi Baiti;'><a href='../?page=city' title='BACK' style='color:white;'>BACK</a></div></center/>";
